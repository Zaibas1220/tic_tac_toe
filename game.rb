...
class Game
  ...
  def game_set_up
    ...
    puts display_player_symbol(@first_player.name, @first_player.symbol)
    @second_player = create_player(2)
    puts display_player_symbol(@second_player.name, @second_player.symbol)
  end
